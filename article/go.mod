...
require (
	github.com/dgnabasik/acmsearchlib/conditional v0.0.0-20210330203704-4d6c0764bfa2
	...
	github.com/dgnabasik/acmsearchlib/nulltime v0.0.0-20210330203704-4d6c0764bfa2
